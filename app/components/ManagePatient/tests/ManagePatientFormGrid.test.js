...
describe('<ManagePatientFormGrid />', () => {
  ...
  describe('style tests', () => {
    ...
    it('should have default styles', () => {
      ...
      expect(renderedComponent).toHaveStyleRule('grid-template-areas', '"generalInformationSubtitle"    "firstName"    "lastName"    "birthDate"    "genderCode"    "birthSex"    "race"    "ethnicity"    "language"    "identifierGroup"    "addresses"    "contacts"    "flags"    "buttonGroup"');
    });
    ...
    it('should have styles in min-width: 768px', () => {
      ...
      expect(renderedComponent).toHaveStyleRule('grid-template-areas', '"generalInformationSubtitle generalInformationSubtitle"      "firstName lastName"      "birthDate genderCode"      "birthSex race"      "ethnicity language"      "identifierGroup identifierGroup"      "contacts contacts"      "addresses addresses"      "flags flags"      "buttonGroup ."', { media });
    });
