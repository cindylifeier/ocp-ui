  ...
  return (
    <div>
      <Formik
        onSubmit={(values) => {
          if (initialValues) {
            onRemovePurposeOfUse(initialValues.index);
          }
          onAddPurposeOfUse(values);
          handleCloseDialog();
        }}
...
PurposeOfUseForm.propTypes = {
  onAddPurposeOfUse: PropTypes.func.isRequired,
  onRemovePurposeOfUse: PropTypes.func.isRequired,
