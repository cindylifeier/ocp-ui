...
describe('<HealthcareServiceTable />', () => {
  ...
  it('should contain identifier systems and values', () => {
    // Arrange
    // element1
    const logicalId1 = 'logicalId1';
    const name1 = 'name1';
    ...
    // Assert
    expect(renderedComponent.contains(identifierSystem1)).toBe(true);
    expect(renderedComponent.contains(identifierSystem2)).toBe(true);
    expect(renderedComponent.contains(identifierSystem3)).toBe(true);
    expect(renderedComponent.contains(identifierSystem4)).toBe(true);
    expect(renderedComponent.contains(identifierValue1)).toBe(true);
    expect(renderedComponent.contains(identifierValue2)).toBe(true);
    expect(renderedComponent.contains(identifierValue3)).toBe(true);
    expect(renderedComponent.contains(identifierValue4)).toBe(true);
  });

  it('should contain formatted identifiers', () => {
    // Arrange
    // element1
    const logicalId1 = 'logicalId1';
    const name1 = 'name1';
    ...
    // Assert
    expect(renderedComponent.contains((<div>{`${identifierSystem1}: ${identifierValue1}`}<br /></div>))).toBe(true);
    expect(renderedComponent.contains((<div>{`${identifierSystem2}: ${identifierValue2}`}<br /></div>))).toBe(true);
    expect(renderedComponent.contains((<div>{`${identifierSystem3}: ${identifierValue3}`}<br /></div>))).toBe(true);
    expect(renderedComponent.contains((<div>{`${identifierSystem4}: ${identifierValue4}`}<br /></div>))).toBe(true);
  });
