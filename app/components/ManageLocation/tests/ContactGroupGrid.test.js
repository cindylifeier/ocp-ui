...
describe('<ContactGroupGrid />', () => {
  describe('snapshot tests', () => {
    it('should match snapshot', () => {
      ...
      // Act
      const renderedComponent = shallow(<ContactGroupGrid>{children}</ContactGroupGrid>);
  ...
  describe('style tests', () => {
    ...
    it('should have default styles', () => {
      ...
      expect(renderedComponent).toHaveStyleRule('grid-template-areas', '"telecomSystem"    "telecomSystemValue"');
    });
    ...
    it('should have styles in min-width: 768px', () => {
      ...
      expect(renderedComponent).toHaveStyleRule('grid-template-areas', '"telecomSystem telecomSystemValue"', { media });
    });
  });
});
