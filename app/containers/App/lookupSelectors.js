...
const makeSelectFlagStatuses = () => createSelector(
  selectGlobalDomain,
  (globalState) => globalState.get(GLOBAL_LOOKUP_STATE_KEY).get(FLAG_STATUS).toJS(),
);

const makeSelectFlagCategories = () => createSelector(
  selectGlobalDomain,
